// E-book pages — "He Had Never Touched Me, Until That Day in the Kitchen"
// 53 pages: cover + 51 content + final
window.EBOOK_PAGES = [
  { type: 'cover' },
  // ===== PROLOGUE =====
  { chapter: 'Prólogo', title: 'Aquele Dia na Cozinha', img: 'midia/ebook/pag-001.jpg', body:
    `<p>From the very first moment she stepped onto that Texas ranch, he looked at her like a man already lost. He loved her — quietly, fiercely, painfully. He wanted her in ways that kept him awake every single night.</p>
  ...
  // ===== CAPÍTULO 1 — PROMISED LAND (5 pages) =====
  { chapter: 'Capítulo 1', title: 'Promised Land', img: 'midia/ebook/pag-001.jpg', body:
    `<p>The dirt road seemed to stretch on forever, winding through golden grass that bent low under the heavy Texas wind.</p>
  ...
  { chapter: 'Capítulo 1', title: 'Promised Land', img: 'midia/ebook/pag-002.jpg', body:
    `<p>She had said yes when her uncle sat her down at the kitchen table, his hands folded, his voice flat, and told her about a man named Dante Sullivan who owned a piece of land out west and needed a wife.</p>
  ...
  { chapter: 'Capítulo 1', title: 'Promised Land', img: 'midia/ebook/pag-003.jpg', body:
    `<p>Dante stepped out from the stable, and for a moment her whole world seemed to pause.</p>
  ...
  { chapter: 'Capítulo 1', title: 'Promised Land', img: 'midia/ebook/pag-002.jpg', body:
    `<p>He walked toward her without a word. Opened the truck door. And when she finally swung her legs out, the hem of her dress catching against the metal step, he reached up.</p>
  ...
  { chapter: 'Capítulo 1', title: 'Promised Land', img: 'midia/ebook/pag-003.jpg', body:
    `<p>For one second too long, he held her close. Close enough that she felt the rise and fall of his chest against her own. Close enough that she could smell the faint warmth of his skin — sun and earth and clean cotton.</p>
  ...
  // ===== CAPÍTULO 2 — THE DISTANCE THAT BURNS (4 pages) =====
  { chapter: 'Capítulo 2', title: 'The Distance That Burns', img: 'midia/ebook/pag-004.jpg', body:
    `<p>The days on the ranch had a rhythm of their own.</p>
  ...
  { chapter: 'Capítulo 2', title: 'The Distance That Burns', img: 'midia/ebook/pag-005.jpg', body:
    `<p>Sometimes there was a small jar beside it, filled with wildflowers he had picked from the field — bluebonnets, Indian paintbrush, tiny white blossoms she didn't know the names of. He never said he had picked them. And when she asked, he only shrugged and looked away.</p>
  ...
  { chapter: 'Capítulo 2', title: 'The Distance That Burns', img: 'midia/ebook/pag-006.jpg', body:
    `<p>At night, it was worse. The bed they shared was narrow — too narrow for two grown bodies pretending not to feel each other.</p>
  ...
  { chapter: 'Capítulo 2', title: 'The Distance That Burns', img: 'midia/ebook/pag-005.jpg', body:
    `<p>His whole body went stone-still. He didn't turn. He didn't pull away. He just stayed there, frozen, as if her touch had stopped time itself. She heard him exhale — a long, broken sound that came from somewhere deep in his chest.</p>
  ...
  // ===== CAPÍTULO 3 — LOOKS THAT TOUCH (4 pages) =====
  { chapter: 'Capítulo 3', title: 'Looks That Touch', img: 'midia/ebook/pag-007.jpg', body:
    `<p>The barn was bathed in golden light.</p>
  ...
  { chapter: 'Capítulo 3', title: 'Looks That Touch', img: 'midia/ebook/pag-008.jpg', body:
    `<p>She felt his presence the way one feels a storm gathering on the horizon — that low pressure in the air, that quiet knowing. His footsteps had stopped at the wide barn entrance. His silence had folded itself around the whole space.</p>
  ...
  { chapter: 'Capítulo 3', title: 'Looks That Touch', img: 'midia/ebook/pag-007.jpg', body:
    `<p>His boots crossed the wooden floor of the barn in quiet, measured steps, and then he was behind her. Close. <em>Too close.</em></p>
  ...
  { chapter: 'Capítulo 3', title: 'Looks That Touch', img: 'midia/ebook/pag-008.jpg', body:
    `<p>But Dante's hands curled into fists. She heard the sharp inhale through his nose, the soft creak of his boots as he forced himself to take one step back. Then another.</p>
  ...
  // ===== CAPÍTULO 4 — THE FIRST PROVOCATION (5 pages) =====
  { chapter: 'Capítulo 4', title: 'The First Provocation', img: 'midia/ebook/pag-009.jpg', body:
    `<p>If he wouldn't come to her, then she would go to him.</p>
  ...
  { chapter: 'Capítulo 4', title: 'The First Provocation', img: 'midia/ebook/pag-010.jpg', body:
    `<p>That afternoon, she chose carefully.</p>
  ...
  { chapter: 'Capítulo 4', title: 'The First Provocation', img: 'midia/ebook/pag-009.jpg', body:
    `<p>She heard him before she saw him.</p>
  ...
  { chapter: 'Capítulo 4', title: 'The First Provocation', img: 'midia/ebook/pag-010.jpg', body:
    `<p>"Alyssa." His voice was lower than she had ever heard it.</p>
  ...
  { chapter: 'Capítulo 4', title: 'The First Provocation', img: 'midia/ebook/pag-011.jpg', body:
    `<p>His voice cracked on the words. Low. Rough. Almost broken. It wasn't a flirtation. It wasn't a tease. <em>It was a man surrendering pieces of himself out loud.</em></p>
  ...
  // ===== CAPÍTULO 5 — QUESTIONS WITHOUT ANSWERS (5 pages) =====
  { chapter: 'Capítulo 5', title: 'Questions Without Answers', img: 'midia/ebook/pag-012.jpg', body:
    `<p>The kitchen smelled of fresh bread.</p>
  ...
  { chapter: 'Capítulo 5', title: 'Questions Without Answers', img: 'midia/ebook/pag-013.jpg', body:
    `<p>She heard his boots on the porch. Then the creak of the screen door. Then the quiet sound of his hat being set down on the table behind her.</p>
  ...
  { chapter: 'Capítulo 5', title: 'Questions Without Answers', img: 'midia/ebook/pag-012.jpg', body:
    `<p>Slowly, finally, she turned around. Dante stood there with his head bowed. His broad shoulders were hunched forward, his palms pressed hard against the table as if he needed it to stay upright.</p>
  ...
  { chapter: 'Capítulo 5', title: 'Questions Without Answers', img: 'midia/ebook/pag-013.jpg', body:
    `<p>She saw the truth then. <em>She saw a man who was terrified.</em> Not of her. Of himself.</p>
  ...
  { chapter: 'Capítulo 5', title: 'Questions Without Answers', img: 'midia/ebook/pag-014.jpg', body:
    `<p>"Dante…" she whispered. "You don't get to decide that for me."</p>
  ...
  // ===== CAPÍTULO 6 — ALMOST LOSING CONTROL (5 pages) =====
  { chapter: 'Capítulo 6', title: 'Almost Losing Control', img: 'midia/ebook/pag-015.jpg', body:
    `<p>The storm came without warning.</p>
  ...
  { chapter: 'Capítulo 6', title: 'Almost Losing Control', img: 'midia/ebook/pag-016.jpg', body:
    `<p>But she never hit the ground.</p>
  ...
  { chapter: 'Capítulo 6', title: 'Almost Losing Control', img: 'midia/ebook/pag-015.jpg', body:
    `<p>He didn't let her go. For one long, suspended moment — <em>he didn't let her go.</em></p>
  ...
  { chapter: 'Capítulo 6', title: 'Almost Losing Control', img: 'midia/ebook/pag-016.jpg', body:
    `<p>"If I start…" His forehead pressed harder against hers. His thumb stroked, just once, against the base of her skull, sending a shiver down the entire length of her spine. "If I start, I don't know if I can stop."</p>
  ...
  { chapter: 'Capítulo 6', title: 'Almost Losing Control', img: 'midia/ebook/pag-017.jpg', body:
    `<p>He let her go. Slowly. Carefully. Like a man setting down something fragile he hadn't realized he was carrying.</p>
  ...
  // ===== CAPÍTULO 7 — FIRE BENEATH THE SKIN (5 pages) =====
  { chapter: 'Capítulo 7', title: 'Fire Beneath the Skin', img: 'midia/ebook/pag-018.jpg', body:
    `<p>Alyssa decided, quietly, that this would be the last night of waiting.</p>
  ...
  { chapter: 'Capítulo 7', title: 'Fire Beneath the Skin', img: 'midia/ebook/pag-019.jpg', body:
    `<p>She made supper slowly. Carefully. She wore a soft blue dress that buttoned down the front. Her hair was loose. Her feet were bare. The whole house was warm with the smell of stew simmering on the stove.</p>
  ...
  { chapter: 'Capítulo 7', title: 'Fire Beneath the Skin', img: 'midia/ebook/pag-018.jpg', body:
    `<p>Later, in the narrow hallway, when they met in the middle, she let her shoulder graze the hard line of his chest as she passed. She heard him stop dead behind her. She heard the breath catch in his throat.</p>
  ...
  { chapter: 'Capítulo 7', title: 'Fire Beneath the Skin', img: 'midia/ebook/pag-020.jpg', body:
    `<p>His hands landed on her waist. <em>Both of them.</em></p>
  ...
  { chapter: 'Capítulo 7', title: 'Fire Beneath the Skin', img: 'midia/ebook/pag-019.jpg', body:
    `<p>His mouth came so close. <em>So close.</em></p>
  ...
  // ===== CAPÍTULO 8 — THE NIGHT IN THE KITCHEN (6 pages — CLÍMAX) =====
  { chapter: 'Capítulo 8', title: 'The Night in the Kitchen', img: 'midia/ebook/pag-020.jpg', body:
    `<p>It was deep into the night.</p>
  ...
  { chapter: 'Capítulo 8', title: 'The Night in the Kitchen', img: 'midia/ebook/pag-021.jpg', body:
    `<p>She slipped out from under the quilt, her bare feet finding the cool wood of the floor. She wore only her simple white cotton nightgown — the modest one. Nothing about it was meant to provoke. <em>And maybe that was exactly why it would.</em></p>
  ...
  { chapter: 'Capítulo 8', title: 'The Night in the Kitchen', img: 'midia/ebook/pag-020.jpg', body:
    `<p>"Alyssa." His voice was low. Hoarse. "Go back to bed."</p>
  ...
  { chapter: 'Capítulo 8', title: 'The Night in the Kitchen', img: 'midia/ebook/pag-022.jpg', body:
    `<p>She lowered herself slowly, until her forehead came to rest against his.</p>
  ...
  { chapter: 'Capítulo 8', title: 'The Night in the Kitchen', img: 'midia/ebook/pag-021.jpg', body:
    `<p>She didn't answer with words.</p>
  ...
  { chapter: 'Capítulo 8', title: 'The Night in the Kitchen', img: 'midia/ebook/pag-022.jpg', body:
    `<p>It was deep. It was slow. It was years of held breath finally let out. His mouth moved against hers like a man who had been starving — but starving with patience, with reverence.</p>
  ...
  // ===== CAPÍTULO 9 — AFRAID OF HURTING HER (5 pages) =====
  { chapter: 'Capítulo 9', title: 'Afraid of Hurting Her', img: 'midia/ebook/pag-023.jpg', body:
    `<p>When Alyssa woke, the bed beside her was cold.</p>
  ...
  { chapter: 'Capítulo 9', title: 'Afraid of Hurting Her', img: 'midia/ebook/pag-024.jpg', body:
    `<p>She wrapped a thin shawl around her bare shoulders and walked barefoot down the hallway. She found him on the porch. Already dressed. Boots laced. Shirt buttoned to the collar — buttoned high, like a man trying to cover up the evidence of what his hands had been doing only hours before.</p>
  ...
  { chapter: 'Capítulo 9', title: 'Afraid of Hurting Her', img: 'midia/ebook/pag-023.jpg', body:
    `<p>"I was too rough with you." The words came out low and pained.</p>
    <p>"You weren't."</p>
  ...
  { chapter: 'Capítulo 9', title: 'Afraid of Hurting Her', img: 'midia/ebook/pag-025.jpg', body:
    `<p>"Dante." She caught his face in her hands. "Stop. You didn't hurt me."</p>
  ...
  { chapter: 'Capítulo 9', title: 'Afraid of Hurting Her', img: 'midia/ebook/pag-024.jpg', body:
    `<p>"I want every mark you put on me, Dante Sullivan."</p>
  ...
  // ===== CAPÍTULO 10 — UNAFRAID TO LOVE (6 pages) =====
  { chapter: 'Capítulo 10', title: 'Unafraid to Love', img: 'midia/ebook/pag-025.jpg', body:
    `<p>The days that followed felt like a different life.</p>
  ...
  { chapter: 'Capítulo 10', title: 'Unafraid to Love', img: 'midia/ebook/pag-024.jpg', body:
    `<p>He kissed her now.</p>
  ...
  { chapter: 'Capítulo 10', title: 'Unafraid to Love', img: 'midia/ebook/pag-023.jpg', body:
    `<p>It was a Saturday evening when he saddled the horses.</p>
  ...
  { chapter: 'Capítulo 10', title: 'Unafraid to Love', img: 'midia/ebook/pag-025.jpg', body:
    `<p>"What did you want to show me?" she whispered.</p>
  ...
  { chapter: 'Capítulo 10', title: 'Unafraid to Love', img: 'midia/ebook/pag-022.jpg', body:
    `<p>"I love you, Alyssa Sullivan." His voice was steady this time. There was no shaking. No fear. No running.</p>
  ...
  { chapter: 'Capítulo 10', title: 'Unafraid to Love', img: 'midia/ebook/pag-024.jpg', body:
    `<p>He kissed her. It wasn't urgent this time. It wasn't desperate. <em>It was the slow, full kiss of a man who had stopped running, holding the woman who had been right all along.</em></p>
